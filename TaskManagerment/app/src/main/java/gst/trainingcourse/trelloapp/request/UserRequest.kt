...
class UserRequest {
    ...
    companion object {
        ...
        fun login(email: String, password: String, callback: (userId: Int?) -> Unit): Unit {
            collection
                ...
                .addOnSuccessListener { result ->
                    for (document in result) {
                        if (password == document.data.getValue("password")) {
                            callback(document.data.getValue("id").toString().toInt())
                        } else {
                            callback(null)
                        }
                    }
        ...
        fun register(user: User, callback: (userId: Int?) -> Unit): Unit {
